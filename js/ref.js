...
const snippetsRef = {
    ...
    'Pavement Conditions': {
        ...
        text: {
            why: `<p>The region's roadways enable mobility and commerce throughout the region. Pavement in poor condition causes unnecessary vehicle damage, increasing the cost of driving, and slows down traffic, increasing congestion. The cost of shipping is passed on to consumers when they pay for goods and services. Nearly all freight movement is completed by truck for some portion of the trip. Therefore, how well we maintain the road network has an impact on how much we pay for the everyday products and services we need or want. Savings generated by good road conditions have a positive impact on our economy.</p><p>oads can be kept in good condition with proper maintenance for a much lower cost than reconstructing a road that has fallen into a state of disrepair. Regular resurfacing and preservation helps to maintain good pavement condition. This ensures that our roads are smooth and safe for operation. Typically, a road is resurfaced every 12 to 15 years, though a high-traffic volume interstate may be resurfaced every seven years, while a lower-volume collector road may be resurfaced only every 25 years.</p>`,
            what: `<p>Both the New JerseyDepartment of Transportation (NJDOT) and the Pennsylvania Department of Transportation (PennDOT) track pavement condition as required by federal regulations for state-maintained and National Highway System (NHS) roadways. PennDOT maintains a Pavement Asset Management System (PAMS), which tracks the condition of all federal- and state-maintained roadways. The PAMS tracks conditions for each road segment in the region. One measure of road condition is the International Roughness Index (IRI). The IRI determines pavement roughness conditions based on total inches of surface variation per mile.</p>`,
            how: ``
        }
    }
}
