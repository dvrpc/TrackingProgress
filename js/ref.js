...
const snippetsRef = {
    ...
    'Sex Disparities': {
        ...
        text: {
            ...
            what: `<p>While disparities exist between men and women on a number of levels, the metrics used here are focused on income and workforce participation. These give an indication of how women are able to support themselves and their families relative to men.</p><p>When using U.S. Census Bureau products like the American Community Survey (ACS) or the Decennial Census, we are limited in exploring the realm of sex and gender in a binary scale that suits neither sex nor gender. Refering to household members, the ACS asks, "What is Person[x]'s sex?" and offers two check boxes: male of female. Sex is a term refering to a person's anatomical characteristics. The binary choice in the survey leaves out intersex and trans individuals. Gender refers to a person's identity. People may align with the gender assigned to them at birth (cisgender), a different gender (transgender), or gender non-conforming, genderqueer, gender fluid, or non-binary identities. Since the survey refers to sex, we use the same term, knowing it has limits. Consequently, <em>Tracking Progress</em> sex disparities trends examine differences between whomever chose "male" or "female" for whatever reason they responded in that fashion to those inadequate choices. The term "sex" is also in line with the protections against discrimination based on sex found in Title IX of the Education Amendments Act of 1972—a law DVRPC must comply with as a public agency receiving federal funds.</p><p>Income was adjusted to 2017 dollars according to <a href="https://www.census.gov/programs-surveys/acs/guidance/comparing-acs-data/2017.html" rel="external">Census Bureau guidance</a> on comparing income data from ACS 1 year values with previous ACS releases and the 2000 decennial. Users should be aware that the 2000 decennial asked about income from 1999 and the ACS asks respondents for income in the past 12 months. This means at least some of respondents' income will likely be received in the year prior to the year the respondent was surveyed.</p><p>In order to estimate median income values at aggregate geographies—the DVRPC region, New Jersey Counties, and Pennsylvania Suburban Counties—weighted averages of male and female population were used across component counties.</p><p>The final charts explores <em>labor force participation rates</em> (percent of those 16 to 64 years who are either employed or seeking work, relative to all 16 to 64 year-olds). The third chart displays the gap in participation rate between male and female persons and the fourth chart shows the percent participation for each group.</p>`,
            how: `<p>The gap in median income between male and female persons in the region declined from $17,581 in 2000 to $12,403 2017—a 29.5 percent drop. Looking at the male and female medians themselves, the drop in the income gap is attributable to declining incomes of male persons combined with more stagnant income for female persons in that period—meaning income for the entire working population has declined since 2000. Male income declined or stayed stagnant for six consecutive years due to the recession. It went from $49,308 in 2008  to $43,9001 in 2014 and only climbed half way back to pre-recession levels by 2017 ($46,400). Some of this may be attributable to an older, more male-dominated generation of workers dropping out of the workforce or having to settle with compensation below what they received prior to the recession. Female median income dropped by about $1,700 due to the recession. The median was $33,712 in 2008 and dipped to its lowest point in 2013 ($32,004). It fully recovered to 2008 levels in 2017 ($33,997). While clearly better than 2000, female percentage of male median income has vacillated between 72 and 74 percent from 2011 to 2017. With slightly higher post-recession income gains for males, it remains to be seen whether the improvements since the turn of the millenium will reverse into a widening gap again, stay at recent levels, or drop again soon.</p><p>The gap in male and female labor force participation rate has dropped overall but has shown some minor increases in disparities in recent years. 2005 had a gap of 11.8 percent. This dropped to 7.0 percent in 2011 but has since climbed slightly to 8.3 percent in 2017. Male participation has held in a slightly tighter range in these years 84.8 percent for a high in 2005 and 81.6 in 2011 for a low. Female participation has had a low of 72.9 percent in 2005 and a high of 75.5 in 2009. In 2017, male participation was at 82.5 percent and female was at 74.2.</p>`,
            resource: `<p>For more on how DVRPC incorporates equity, environmental justice, and complies with federal Title VI and other important statutes protecting communities of concern, see our <a href="/GetInvolved/TitleVI/">Title VI and Environmental Justice page</a>, as well as our <a href="/webmaps/IPD/">Indicators of Potential Disadvantage (IPD) tool</a> and <a href="/ETA/">Equity through Access (ETA) project and tool<a/>.<p>DVRPC's <a href="Connections2045/MIT/">Municipal Implementation Toolbox</a> suggests the following tools for reducing disparities between sexes in the region:</p><ul><li><a href="Connections2045/MIT/toolpage.html?tool=5cb77b58fb6fc041ab93009c">Minority- and Women-Owned Business Resources</a></li><li><a href="Connections2045/MIT/toolpage.html?tool=5cb77a80fb6fc041ab930040">Human Capital Investments</a></li><li><a href="Connections2045/MIT/toolpage.html?tool=5bf43435e7179a56e2137e73">Universal Pre-Kindergarten Programs</a></li><li><a href="Connections2045/MIT/toolpage.html?tool=5cb7840afb6fc041ab93097e">Engaging Underserved Communities</a></li></ul>`
        }
    },
    'Roadway Reliability': {
    ...
    'Transit Ridership': {
        ...
        text: {
            ...
            what: `<p>DVRPC tracks transit ridership in the region through unlinked passenger trips, with data provided by each of the region's four transit operators: Southeastern Pennsylvania Transportation Authority (SEPTA), New Jersey Transit (NJ Transit), Port Authority Transportation Company (PATCO), and Pottstown Area Rapid Transit (PART) to the National Transit Database (NTD). Unlinked passenger trips count each passenger boarding, regardless of fare paid. Thus, a trip with a transfer would count as two boardings. Transit ridership does not include Amtrak, shuttles, or private bus passengers. It also does not include services that receive partial funding from SEPTA like SCCOOT and Krapf's "A" Bus.</p><p>The first graph shows the overall number of unlinked trips that occurred in the region each year. The second shows the number of unlinked trips by mode (e.g., bus, rail, etc.). The third graph shows the number of unlinked trips by transit operator. All three graphs can be toggled between total unlinked trips and unlinked trips per capita.</p><p>NJ Transit's ridership figures are for the DVRPC region only. These figures are based on service in the Trenton and Philadelphia Urbanized Area collected by the NTD. PART data are only available from 2008 and forward.</p>`,
            how: `<p>After over a decade of mostly steady growth between 2000 and 2013, transit ridership began to decrease. It suffered an especially sharp decrease between 2016 and 2017 due largely to a significant decline in bus trips. This decline has left unlinked trips per capita essentially unchanged—just a 1.1 percent drop—since 2000 (65.05 unlinked trips per capita in 2000 vs. 64.34 unlinked trips per capita in 2017). Whether this trend reverses and restarts the growth from earlier in the decade or continues to decline will have significant ramifications for the sustainability of the transit system and the overall transportation network.</p><p>Buses are by far the most common used transit mode in the region, at 33.07 unlinked trips per capita in 2017, followed by subways at 18.23 unlinked trips. Commuter and light rail are 3rd and 4th at 6.48 and 5.09 unlinked trips per capita, respectively. All modes except for light rail saw at least a small decline between 2016 and 2017.</p><p>SEPTA is responsible for carrying the large majority of the region's transit passengers, accounting for 324.8 million unlinked trips in 2017. In second was NJ Transit with 33.8 million unlinked trips, or about 10.4% of SEPTA's total. Riders took 10.8 million unlinked trips on PATCO, and 244 thousand on PART.</p>`,
            resource: `<p>DVRPC does extensive work with partner agencies to recommend changes for promoting the Region's  transit system and transit use. Find relevant planning tools, publications, programs, and resources on our <a href="/Transit/">Transit page</a>.</p><p>See what transit investments are proposed for the region, see the Transportation Improvement Program projects for <a href="/TIP/NJ/">New Jersey</a> and <a href="/TIP/PA/">Pennsylvania</a> counties and the <a href="/webmaps/MRP2045/">Long-Range Plan Projects page</a>.</p><p>DVRPC's <a href="/Connections2045/MIT/">Municipal Implementation Toolbox</a> suggests the following tools for communities to keep transit ridership on a positive trend:</p><ul><li><a href="/Connections2045/MIT/toolpage.html?tool=5bf42e6ee7179a56e2137ad8">Complete Streets</a></li><li><a href="/Connections2045/MIT/toolpage.html?tool=5bf42ad8e7179a56e2137827">Transit-Oriented Development (TOD) Zoning</a></li><li><a href="/Connections2045/MIT/toolpage.html?tool=5bf43468e7179a56e2137e9b">Multi-Modal Transportation Hubs and Connections</a></li><li><a href="/Connections2045/MIT/toolpage.html?tool=5bf42b29e7179a56e2137849">Smart Location of Public Facilities</a></li><li><a href="/Connections2045/MIT/toolpage.html?tool=5cb77c06fb6fc041ab930100">Financial Incentives</a></li><li><a href="/Connections2045/MIT/toolpage.html?tool=5cb77a80fb6fc041ab930040">Human Capital Investments</a></li><li><a href="/Connections2045/MIT/toolpage.html?tool=5cb77e73fb6fc041ab9303f5">Shared Mobility Regulatory Framework</a></li><li><a href="/Connections2045/MIT/toolpage.html?tool=5bf42867e7179a56e21376cc">Official Map</a></li></ul>`
        }
    },
    ...
    'Transit Conditions': {
        ...
        text: {
            why: `<p>A well-maintained transit system is vital to moving people around the region. When transit is not maintained, the risk of delayed or cancelled rides increases and reliability decreases. As a result, passengers can be discouraged from using transit and choice users are more likely to drive, causing more congestion, crashes, and air pollution throughout the region. Those who don't have another option, or can't afford one, may not be able reach jobs, medical appointments, education programs, or other important activities. A poorly maintained transit system is also less energy-efficient and requires more regular, costly repairs to stay operational. Much of the region's transit infrastructure spans the 20th century. SEPTA alone has rail bridges that are a century year old, power substations and catenary from the 1930s, commuter train cars from the 1970s, and trolleys from the 1980s. Keeping all this historic infrastructure in functional repair while incorporating new technologies and infrastructure is essential to the region.</p>`,
            what: `<p>Four different agencies provide transit service to the region. SEPTA provides bus and rail service to all five Pennsylvania Counties, and has several commuter rail lines that terminate outside this service area, in New Castle County, Delaware and Mercer County, New Jersey. PATCO operates a passenger rail line connecting Philadelphia with Camden County. New Jersey Transit (NJT) runs buses throughout the four New Jersey counties and into Philadelphia, and has two rail lines in the region: a light rail connecting Camden and Mercer Counties, and two commuter rail lines connecting Philadelphia and Atlantic City and Mercer County to New York City. Finally, Pottstown Area Rapid Transit (PART) provides bus service throughout Pottstown and into several neighboring municipalities in Montgomery County.</p><p>Average age of revenue vehicles is a useful measure of transit maintenance. Generally, rail vehicles have an expected 35-year lifespan, and buses have an expected 13-year lifespan, and maintaining a state of good repair requires keeping an overall average fleet age of half the expected lifespan (i.e., 17.5 years for rail vehicles and 6.5 years for buses). However, each transit agency may define lifespans and state of good repair differently, and refurbishment can significantly extend the useful lifespan of a vehicle, therefore, the average vehicle age can only be considered a general guideline. Vehicle condition also only represents one element of transit system maintenance.  Vehicles also require more regular and frequent replacement than other transit infrastructure, making trends straightforward to identify.</p><p>The Federal Transit Administration's Transportation Performance Measures (TPMs) gauge transit system conditions with four indicators: 1) The percent of non-revenue service vehicles that have either met or exceeded their useful life benchmark (UBL) as identified by the transit agency. 2) The percent of revenue vehicles in each asset class that have either met or exceeded their ULB. 3) The percent of rail track segments with performance restrictions. 4) The percent of facilities within each asset class rated below condition 3 on the Transit Economic Requirements Model scale (which ranges from 1 worst condition to 5 best condition). 2018 was the first year this was required to be reported on in the National Transit Database (transit agencies could voluntarily report this information in 2017). DVRPC will update this indicator with the TPM measures once there is enough data to show a trendline.</p><p>The graphs below present average vehicle age data reported by each of the region's transit agencies as reported to the FTA's National Transit Database, separated by either rail vehicle or bus. Rail vehicles include light rail and trolleys, heavy rail (i.e., subway), and regional rail passenger cars and locomotives.</p><p>The first graph depicts the average age of the rail, bus, and <em<combined fleet</em> (all rail and all buses) by transit agency. The combined fleet average is obtained by taking a weighted average of rail and bus fleets to account for the total number of vehicles. Although the average age of the combined fleet cannot be directly compared to expected lifespans due to the mix of vehicle types, it is useful for identifying the long-term trend in vehicle age across the region. The graph for PART and PATCO does not include a combined fleet average, because these agencies operate only buses and rail vehicles, respectively, in the region. The second and third graphs show the total number of vehicles in the rail fleet and bus fleet, respectively, according to the age of the vehicle (0-5 years, 6-11 years, 12-15 years, 16-20 years, 21-25 years, or older than 25 years). Looking at the age overall distribution is useful because it may indicate that a large number of vehicles are soon to pass their useful life, or that a number of older vehicles were retired without being replaced, which would lower the average fleet age without actually improving the state of the transit system.</p>`,
            how: `<p>Across the region, the average age of a transit vehicle in 2017 was 14.8 years, at 14.3 percent increase since 2000 and a 25 percent increase from a recent low of 11.8 years in 2013. 14.8 years is also the highest average age recorded since 2000. Both the average age of buses and rail vehicles has increased since 2004, with buses increasing in age at a faster rate. Currently, the average vehicle age for both buses and rail vehicles exceeds the state of good repair standard based on a target fleet age of half the expected useful life.</p><p>SEPTA, the largest transit agency in the region, has managed to hold average bus age steady between 6.5 and 10 years since 2000, but has seen a consistent rise in average rail vehicle age, peaking at 29.4 years in 2017. SEPTA's delivery of 120 Silverliner V regional rail vehicles beginning in 2012 has brought the average aging vehicle fleet age down. While these new vehicles replaced the Silverliner II and III vehicles dating from the mid-1960s, the majority of the fleet is still comprised of Silverliner IVs dating primarily from the mid-1970s, and the average age has continued to climb since the Silverliner Vs were introduced. SEPTA has procured a number of bi-level vehicles for regional rail, but have not yet entered service. SEPTA's light rail fleet for the Route 10, 11, 13, 34, 36, 101, and 102 trolley lines dates from 1980 to 1981 and are soon due for replacement. The rehabilitated 1947 PC II trolleys operating on route 15 have an anticipated 20-year lifespan starting from 2005, and will likely be replaced as part of a new ADA-accessible, low-floor trolley fleet.</p><p>PATCO's rail vehicles have also seen a consistent increase in average age since 2000, peaking at 45.5 years in 2017. However, between 2015 and 2019, PATCO performed a complete overhaul and refurbishment its rail vehicles that effectively reset the clock on the useful life of those vehicles. Because these are still the original vehicles, the age did not reset at the same time in the NTD database, highlighting an important limitation of this data.</p>`,
            resource: `<p>DVRPC does extensive work with partner agencies to recommend changes for promoting the Region's  transit system and transit use. Find relevant planning tools, publications, programs, and resources on our <a href="/Transit/">Transit page</a>.</p><p>See what transit investments are proposed for the region, see the Transportation Improvement Program projects for <a href="/TIP/NJ/">New Jersey</a> and <a href="/TIP/PA/">Pennsylvania</a> counties and the <a href="/webmaps/MRP2045/">Long-Range Plan Projects page</a>.</p><p>DVRPC's <a href="/Connections2045/MIT/">Municipal Implementation Toolbox</a> suggests the following tools for communities to improve transit conditions in our communities:</p><ul><li><a href="/Connections2045/MIT/toolpage.html?tool=5bf42f47e7179a56e2137b4f">Impact Fees</a></li><li><a href="/Connections2045/MIT/toolpage.html?tool=5c9300d5e7179a0e408a23f9">Shared Services</a></li><li><a href="/Connections2045/MIT/toolpage.html?tool=5cb8d9c7e7179a264cf2c447">Tourism Improvement District (TID)</a></li></ul>`
        }
    },
    'Innovation': {
