const snippetsRef = {
    ...
    'Global Connectivity': {
        ...
        text: {
            why: `<p>International flight offerings from Philadelphia International Airport (PHL) indicate how connected our region is to the rest of the world for commerce and leisure activities. Each day, flights from international destinations bring global business travelers to meetings that maintain and expand business opportunities in our region, along with visitors that boost the region's travel and tourism industry. The growth of direct flights to and from international destinations connects more markets to the region, and the region's market to the globe.</p>`,
            what: `<p>Since 2009, PHL releases the number of destinations that can be reached through a direct flight at PHL. The chart can toggle between displaying all international flight destinations by the destination airport's general location and distinguish between which destinations are seasonal and which are year round.</p>`,
            how: `<p>In 2019 the number of direct international destinations from PHL is 40, rebounding back to 2009 levels. The drop in destinations after 2009 was most likely affected by the Great Recession, which caused many companies and families to curtail international travel, and the airline industry responded by reducing destinations. The number of destinations dropped to a low of 33 in 2017. In 2011, destinations were down to 34 but increased to 38 by 2014 with an increased number of flights to the Caribbean. Still, destinations dropped further in subsequent years to 33 in 2017 but increased by one in 2018 and then by six in 2019.</p><p>This fluctuation in international destinations is not uncommon for the airline industry as airlines add and remove flights to accommodate their entire national and international network. Following the American Airlines and US Airways merger in 2013, one might have expected a greater drop in international destinations as PHL's future position as an American Airlines hub came into question. Instead, over the following years there was a shift as Americans chose to keep more of their European capital destinations with connectivity out of New York but grew their connections to second-tier cities from PHL. In 2018 American Airlines added flights to Budapest, Prague, and Zurich, and in 2019 flights to Halifax, Dubrovnik, Bologna, and Berlin.</p><p>Europe remains the top flight destination, with 23 destinations in 2019. The Caribbean (10), Canada (4), Mexico (2) and the Middle East (1) make up less than half the 2019 destinations. Year-round destinations made up 65% of total flights in 2009. They peaked in 2014 at 74% but have since dropped to just 50% in 2019.</p><p>Although total destinations have rebounded, the number of seasonal flights may point to a stronger focus on leisure travel from PHL relative to business travel. Without a diversity of consistent, year-round destinations, it is harder for businesses in the region to connect to international markets and for businesses abroad to connect with us.</p>`,
            resource: `<p>DVRPC's <a target="_blank" rel="noopener" href="/Connections2045/MIT/"><em>Municipal Implementation Toolbox</em></a> (MIT) suggests the following tools to augment the attractiveness of regional destinations and ways foreign travelers and others can access them.</p><ul><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5cb8d9c7e7179a264cf2c447">Tourism Improvement District (TID)</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf43468e7179a56e2137e9b">Multimodal Transportation Hubs</a></li></ul><p>Successfully implemented economic development strategies and others found in DVRPC's <a target="_blank" rel="noopener" href="/Economic/CEDS/">Comprehensive Economic Development Strategy (CEDS)</a> may help make the case for increasing international connections at our airport hub.</p>`
        }
    },
    'Housing Activity': {
        ...
        text: {
            ...
            what: `<p>Residential construction activity data is derived from current reports and publications compiled by the U.S. Census Bureau's Residential Construction Statistics Division. Municipalities provide the U.S. Census Bureau with tabulations of the number of housing units authorized, according to types of structures. In the few cases where municipalities reported building permit activity for some months but not for all 12 months, the U.S. Census Bureau estimates the total yearly number of building permits based on past building permit activity.</p><p>The first chart looks at where residential development activity is occurring. The Connections 2045 Plan defines four planning areas: Core Cities, Developed Communities, Growing Suburbs, and Rural Areas. Development activity in Core Cities and Developed Communities utilizes existing infrastructure and helps preserve undeveloped land. The chart shows the trendline for percentage of building permits approved in Core Cities and Developed Communities since 1980.</p><p>The second chart shows the count of all permits approved by all four Planning Areas.</p><p>The third chart presents units authorized by structure type. Note that mobile homes are not included in residential building permits data. The following are definitions of structure types used:</p><ul><li><em>Single-family</em> are single-unit structures, including attached, detached and semi-detached, and row houses, provided the units are separated by a ground-to-roof party wall.</li><li><em>Small multifamily</em> structures are those containing two to four units, including duplexes and triplexes.</li><li><em>Large multifamily</em> structures are those with five or more units. Garden apartments and high-rise buildings are included in this category, as well as condominiums and cooperatively owned apartment buildings.    </li></ul><p>All three charts allow you to view trends both annually and cumulatively since the base year of 1980.</p>`,
            how: `<p>While the absolute numbers of building permits issued in the entire region per year are fewer than in 1999, the proportion of building permits issued in Core Cities and Development Communities in 2018 has increased by 29.8% to 63.6% of all permits issued. Since 2012 the annual percentage of residential building permits being approved in Core Cities and Developed Communities has risen to over 60% of all approvals—levels not seen since the early 1980s. This figure peaked at 69.3% in 2014 and has subsequently remained high with 63.5% of units approved in 2018. The late 1990s and early 2000s saw the lowest proportion of approvals in these smart growth areas, as units built drifted to municipalities categorized as Growing Suburbs and Rural Areas.</p><p>Looking at cumulative units approved since 1980, 50% of all units by 1996 were built in Rural Areas and Growing Suburbs. By 2018, 49.4% of all units were built in Core Cities and Developed Communities, possibly indicating that trend of greenfield development may be over. When selecting only single planning areas in Chart 2, it's clear that the recent uptick in housing activity is driven almost entirely from City of Philadelphia growth.</p><p>Total permits approved are seen in Charts 2 and 3. The peak year for approving units in the region came in 1986 with close to 30,000 units approved. The most recent recession brought approvals to just 20% of those peak levels in 2009 with 6,182 approved that year. The year 2018 had 12,075 units approved, showing that approvals have doubled since the slowest years but housing activity is clearly not what it once was in the region.</p><p>Chart 3 shows a waning interest in single-family development that dominated small and large multifamily development structures until more recent years. The year 2018 saw nearly identical single-family (5,561) and large multifamily (5,562) approvals and an additional 952 small multifamily units. But the cumulative effects of decades of single-family preference means that more than 75% of units approved from 1980 to 2018 were single family.</p>`,
            resource: `<p>See what DVRPC is doing in the area of livable community building on its <a target="_blank" rel="noopener" href="/SmartGrowth/">Smart Growth page</a>.</p><p>DVRPC's <a target="_blank" rel="noopener" href="/Connections2045/MIT/"><em>Municipal Implementation Toolbox</em></a> suggests the following tools for improving the trendline for smarter residential growth in the region:</p><ul><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf42ad8e7179a56e2137827">Transit-Oriented Development (TOD) Zoning</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5c929a05e7179a0e4089fae5">Revitalization Planning and Programs</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5c929acde7179a0e4089fb5d">Brownfields Redevelopment</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf42b77e7179a56e2137867">Building Missing Middle Housing</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5c929ecee7179a0e4089fdad">Live/Work Zoning</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5cb7796efb6fc041ab92fe9b">Streamlined Permitting Processes</a></li></ul><p>For more detail on housing activity by municipality, <a href="https://docs.google.com/spreadsheets/d/1h6fO11loLQkFot7AW2XissyvLaim8Xkg/edit#gid=992334532" rel="noopener" target="_blank">download this table of historic residential building permit approvals</a>. Select the tabs to get total permits or approvals by structure type.</p>`
        }
    },
    ...
    'Sex Disparities': {
        ...
        text: {
            ...
            what: `<p>Although disparities exist between men and women on a number of levels, the metrics used here are focused on income and workforce participation. These give an indication of how women are able to support themselves and their families relative to men.</p><p>When using U.S. Census Bureau products like the American Community Survey (ACS) or the decennial census, we are limited in exploring the realm of sex and gender in a binary scale that suits neither sex nor gender. Referring to household members, the ACS asks, "What is Person[x]'s sex?" and offers two check boxes: male or female. <em>Sex</em> is a term referring to a person's anatomical characteristics. The binary choice in the survey leaves out intersex and trans individuals. <em>Gender</em> refers to a person's identity. People may identify with the gender assigned to them at birth (cisgender), a different gender (transgender), or gender non-conforming, genderqueer, gender fluid, or non-binary identities. Since the survey refers to sex, we use the same term, knowing it has limits. Consequently, <em>Tracking Progress</em> sex disparities trends examine differences between whomever chose "male" or "female" for whatever reason they responded in that fashion to those inadequate choices. The term sex is also in line with the protections against discrimination based on sex found the <a href="https://www.law.cornell.edu/uscode/text/23/324" rel="noopener" target="_blank">Federal-Aid Highway Act of 1973</a>—a law DVRPC must comply with as a public agency receiving federal funds.</p><p>Income was adjusted to 2017 dollars according to <a href="https://www.census.gov/programs-surveys/acs/guidance/comparing-acs-data/2017.html" rel="noopener" target="_blank">U.S. Census Bureau guidance</a> on comparing income data from ACS one-year values with previous ACS releases and the 2000 decennial. Users should be aware that the 2000 decennial asked about income from 1999, and the ACS asks respondents for income in the past 12 months. This means at least some of respondents' income will likely be received in the year prior to the year the respondent was surveyed.</p><p>Median income trends are found in the first and second chart. The first shows the difference, or gap, between male and female or the female percentage of male income, depending on the value type selected. The second shows total median income trends for both male and female. In order to estimate median income values at aggregate geographies—the DVRPC region, New Jersey counties, and Pennsylvania suburban counties—weighted averages of male and female population were used across component counties.</p><p>The final charts explore <em>labor force participation rates</em> (percentage of those aged 16 to 64 years who are either employed or seeking work, relative to all 16- to 64-year-olds). The third chart displays the gap in participation rate between male and female persons and the fourth chart shows the percentage of participation for each group.</p><p><em>Note: In November, 2019, the Census Bureau issued <a href="https://www.census.gov/programs-surveys/acs/technical-documentation/errata/121.html" rel="noopener" target="_blank">a statement acknowledging errors in 2017 ACS data for Philadelphia County</a>. The error may impact the Sex Disparities indicator for Philadelphia and regional aggregations. DVRPC is aware of the issue and intends to update Tracking Progress with 2018 ACS data soon.</em></p>`,
            how: `<p>The gap in median income between male and female persons in the region declined from $17,581 in 2000 to $12,403 in 2017—a 29.5% drop. Looking at the male and female medians themselves, the drop in the income gap is attributable to declining incomes of male persons combined with more stagnant income for female persons in that period—meaning that income for the entire working population has declined since 2000. Male income declined or stayed stagnant for six consecutive years due to the recession. It went from $49,308 in 2008 to $43,9001 in 2014 and only climbed halfway back to pre-recession levels by 2017 ($46,400). Some of this may be attributable to an older, more male-dominated generation of workers dropping out of the workforce or having to settle with compensation below what they received prior to the recession. Female median income dropped by about $1,700 due to the recession. The median was $33,712 in 2008 and dipped to its lowest point in 2013 ($32,004). It fully recovered to 2008 levels in 2017 ($33,997). Although clearly better than 2000, female percentage of male median income has vacillated between 72 and 74% from 2011 to 2017. With slightly higher post-recession income gains for males, it remains to be seen whether the improvements since the turn of the millennium will reverse into a widening gap again, stay at recent levels, or drop again soon.</p><p>The gap between male and female labor force participation rates has dropped overall but has shown some minor increases in disparities in recent years. The year 2005 had a gap of 11.8%. This dropped to 7.0% in 2011 but climbed slightly to 8.3% in 2017. Male participation held in a slightly tighter range in these years: 84.8% for a high in 2005 and 81.6 in 2011 for a low. Female participation had a low of 72.9% in 2005 and a high of 75.5 in 2009. In 2017, male participation was at 82.5% and female was at 74.2.</p>`,
            resource: `<p>For more on how DVRPC incorporates equity and environmental justice, and complies with federal Title VI and other important statutes protecting communities of concern, see our <a target="_blank" rel="noopener" href="/GetInvolved/TitleVI/">Title VI and Environmental Justice</a> page, as well as our <a target="_blank" rel="noopener" href="/webmaps/IPD/">Indicators of Potential Disadvantage</a> tool and <a target="_blank" rel="noopener" href="/ETA/">Equity through Access</a> project and tool.</p><p>DVRPC's <a target="_blank" rel="noopener" href="/Connections2045/MIT/"><em>Municipal Implementation Toolbox</em></a> suggests the following tools for reducing disparities between sexes in the region:</p><ul><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5cb77b58fb6fc041ab93009c">Minority- and Women-Owned Business Resources</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5cb77a80fb6fc041ab930040">Human Capital Investments</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf43435e7179a56e2137e73">Universal Pre-Kindergarten Programs</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5cb7840afb6fc041ab93097e">Engaging Underserved Communities</a></li></ul>`
        }
    },
    'Congestion': {
        ...
        text: {
            why: `<p>It's hard to plan a trip when you have no idea how long it will take. Travelers want reliable travel times from one day to the next. The same peak hours generally occur every weekday, but on any given day, unusual circumstances like crashes, weather, construction activity, or special events can dramatically change the performance of the roadway. This is referred to as <em>nonrecurring</em> congestion. Data collected by the Federal Highway Administration indicates that non-recurring congestion actually accounts for more hours of delay than the everyday (recurring) congestion that results from road capacity constraints and heavy volumes. A reliable network may still have congestion in peak periods, but such congestion will be easier to predict—ensuring the region's residents and goods get to where they are expected to be when they are expected to be there.</p>`,
            what: `<p>Nonrecurring congestion is measured as an index value. It is the ratio of the 95th percentile travel time relative to the free-flow (uncongested) travel time and known as the <em>Planning Time Index</em> (PTI). PTI helps in understanding the impacts of nonrecurring congestion from crashes, weather, and special events. This approximates the extent to which a traveler should add extra time to their trip to ensure on-time arrival at their destination. A value of 1.0 indicates a person can expect free-flow speeds along their route. A 2.0 index value indicates a traveler should expect that the trip could be twice as long as free-flow conditions.</p><p>The data comes from aggregated Global Positioning System probe data—data from mobile apps, connected vehicles, and commercial fleets—provided to the Probe Data Analytics (PDA) Suite by INRIX, a travel data technology company. The PDA Suite was created by a consortium of sponsors, including the I-95 Corridor Coalition and the University of Maryland.</p><p>PTI values by region, subregion, and county are grouped either as freeway facilities or local roads in the first chart. <em>Highways</em> reflects roadway segments classified as interstates, turnpikes, and expressways in the PDA Suite. <em>Local roads</em> are segments classified as U.S. routes, state routes, parkways, frontages, and others. The PDA Suite reports out weekday hourly averages in facility directions (northbound, southbound, eastbound, and westbound) by selected facility types and geographies. The second chart reports an average of these hourly and directional values by facility type, within the following time periods:</p><ul><li>Morning (AM): 6:00 AM–9:59 AM;</li><li>Midday (MD): 10:00 AM–2:59 PM;</li><li>Evening (PM): 3:00 PM–6:59 PM;</li><li>Nighttime (NT): 7:00 PM–5:59 AM; and</li><li>Daily: 12:00 AM–11:59 PM.</li></ul><p>All values reflect an average weekday.</p><p>Although INRIX data collection precedes years reported in <em>Tracking Progress</em>, early years of reporting are highly variable based on a lack of facility coverage. The years from 2011 onward show higher stability for freeway facilities for most counties and for the region. For local facilities, 2014 and beyond is where values seem most stable due to more widespread facility coverage.</p><p>It's important to note that congestion is susceptible to external forces like the economy. A downturn can make for seeming improvements in congestion, but it's really reflecting fewer and shorter trips in leaner times for households and businesses, and may not represent an improvement.  Therefore, it may be useful to correlate these results with the Vehicle Miles Traveled indicator.</p>`,
            how: `<p>Regional freeways have held fairly consistent reliability scores on weekdays in recent years. There was a minor decline in PTI values in the period spanning 2011 (1.33) and 2018 (1.30), indicating 2.3% greater freeway reliability. The lowest PTI score was 1.28, occurring both in 2012 and 2017. 2015 was the second highest with a score of 1.32. Local facilities had weekday daily values in a similar range but showed a steady decline of 0.01 each year from 2014 (1.31) to 2018 (1.27)—a 3.5% increase in reliability.</p><p>Among DVRPC counties, Philadelphia consistently ranks highest for both freeway and local PTI scores. Gloucester and Chester counties rank lowest in the index, or nearest to uncongested conditions.</p><p>Reliability is highly conditional on time period, however. The second chart shows that a weekday evening peak period of 3:00 PM to 7:00 PM is when reliable travel speeds most suffer, particularly on freeways. Down from its peak in 2011 (1.80), the 2018 evening peak was 1.70. By comparison, weekday morning peak periods average around 1.40 on freeways and drop to around 1.10 for overnight. Local facilities tend to have less variability by time period, with weekday morning, midday, and evening values around 1.40 to 1.50. Nighttime is notably lower (averaging 1.11 from 2014 to 2018).</p>`,
            resource: `<p>For more information on transportation system performance and strategies to enhance mobility of people and goods, see DVRPC's <a target="_blank" rel="noopener" href="/CongestionManagement/">Congestion Management</a> process. Additionally, DVRPC <a target="_blank" rel="noopener" href="/Transportation/TSMO/">Transportation Systems Management and Operations (TSM&amp;O)</a> planning programs preserve capacity and improve security, safety, and reliability of the transportation system.</p><p>DVRPC's <a target="_blank" rel="noopener" href="/Connections2045/MIT/"><em>Municipal Implementation Toolbox</em></a> suggests the following tools for improving the reliability of the region's roadways:</p><ul><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf43468e7179a56e2137e9b">Multimodal Transportation Hubs</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5cb782abfb6fc041ab9308f8">Curbside Management</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf4350be7179a56e2137f2e">Travel Demand Management (TDM)</a></li></ul>`
        }
    },
    'Exported Goods': {
        ...
        text: {
            ...
            what: `<p>Initial declarations of merchandise export values are reported at the metropolitan and county levels by the <a href="https://www.trade.gov/mas/ian/metroreport/tg_ian_002825.asp" rel="noopener" target="_blank">International Trade Administration</a> using data from the U.S. Census Bureau's Origin of Movement–ZIP code Based Series. This represents the exports of goods. Services exports are not included in this dataset.</p><p>Goods exports data reported at the subnational level relies on initial declarations and does not get updated with subsequent revisions found in national data. Export county is assigned using the address of the United States Principal Party in Interest of record—which is often, but not always, the entity producing the merchandise.</p><p>A small portion of the overall metropolitan Core Based Statistical Area (CBSA) export value does not have a county determination. DVRPC assigned this residual CBSA value to counties according to the portion of the CBSA's export value attributable to each county. Values were then adjusted by consumer price index factors to 2017 dollars. Despite inherent errors, this data is a relevant gauge of where the region stands based off previous years. Merchandise export data by county is available starting in 2012.</p>`,
            how: `<p>The value of merchandise exports from the region was over $18.2 billion in 2018, a drop of 8.9% since 2012. These exports were steady from 2012 through 2014, followed by a decline to about $16.5 billion in 2016. 2017 showed an uptick, over 2016, and 2018 continued this trend with a gain of $1.062 billion. The total regional exports have recovered some value from previous decreases but remain below the 2013 peak of almost $21.06 billion.</p><p>With exports valued at over $4.2 billion in 2018, Montgomery County has led the region in export activity every year since 2012. All of the Pennsylvania suburban counties experienced moderate export growth from 2017 to 2018. Philadelphia experienced a small contraction in exports between 2017 and 2018. In the New Jersey portion of the region, Gloucester County continued to be the largest merchandise exporter with 2018 exports totaling $2.135 billion.</p><p>Merchandise export data at the industry level is not available for county-level analysis. However, metropolitan statistical area (MSA)-level statistics reveal patterns that are likely contributing to the trends seen in DVRPC counties. The leading industries for merchandise export at MSA level are related to pharmaceutical, basic chemical, and resin manufacturing (North American Industry Classification System 3254, 3251, and 3252). Pharmaceutical exports have dropped since 2014 and show only a moderate recovery in 2018. Additionally, petroleum manufacturing exports have been in a steady decline since 2014. Supplementing these losses are growing exports from industries, including plastics manufacturing and medical equipment and supplies manufacturing, as well as a rebound in aerospace product and parts manufacturing.</p>`,
            resource: `<p>For more data on regional trade and freight transportation, go to DVRPC's <a target="_blank" rel="noopener" href="/webmaps/phillyfreightfinder/"><em>PhillyFreightFinder</em></a>.</p><p>DVRPC works with its planning partners on <a target="_blank" rel="noopener" href="/Economic/">economic development</a> and analysis in the region, including our <a target="_blank" rel="noopener" href="/Economic/CEDS/">Comprehensive Economic Development Strategy (CEDS)</a>.</p><p>DVRPC's <a target="_blank" rel="noopener" href="/Connections2045/MIT/"><em>Municipal Implementation Toolbox</em></a> suggests the following tools to attract, retain, and grow business opportunities in the region. These may in turn improve the trendline for regional exports:</p><ul><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf42edbe7179a56e2137b04">Economic Development Task Force</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5cb77a06fb6fc041ab92ffe3">Business Incubators</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf42f68e7179a56e2137b5f">Universal Internet Access</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5cb77b58fb6fc041ab93009c">Minority- and Women-Owned Business Resources</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5cb7796efb6fc041ab92fe9b">Streamlined Permitting Processes</a></li></ul>`
        }
    },
    'Commute Mode': {
    ...
    'Water Quality': {
        ...
        text: {
            ...
            what: `<p>The federal Clean Water Act was established to restore and maintain the chemical, physical, and biological integrity of the nation's waters. Water quality standards have been established by federal and state governments to ensure that waterbodies attain their <em>designated uses</em>. Designated uses include human uses and ecological conditions: general aquatic life, trout, recreation, drinking water supply, industrial water supply, agricultural water supply, shellfish harvesting, and fish consumption.</p><p>As mandated by the Clean Water Act, surface water quality in all states is monitored and assessed every two years. During this time, government-employed scientists take samples of water at various waterbody sites and test them to determine whether or not that waterbody has attained its designated use(s). The designated use of general aquatic life is the most indicative of overall surface water quality and is the most comprehensively monitored across the region. Therefore, aquatic life is used as the indicator of regional water quality.</p><p>Water quality in Pennsylvania is assessed based on stream segments. Attainment (or lack of attainment) is determined by analyzing the health of <em>aquatic macroinvertebrates</em> (i.e. insect larvae, crayfish, clams, snails, worms) present in the stream.  Pennsylvania's Department of Environmental Protection's (PADEP) assessment plan covers the entire state in 10-year increments. Interim evaluations are performed using targeted sampling in each of the state's major subwatersheds every two years.  New Jersey Department of Environmental Protection (NJDEP), on the other hand, assigns attainment or lack of attainment to entire subwatersheds (land area). Similar to PADEP, this determination is based on in-stream sampling of macroinvertebrates.   New Jersey's most recent report for 2014 is based on data collected between 2008 and 2012.</p><p>Since the two states do not report  water quality data using the same criteria (stream miles in Pennsylvania versus acres of subwatershed in New Jersey), the percentage of non-attaining water(s) in each state is taken according to its preferred unit, and then the two percentages are averaged together to obtain a regional value.</p><p>The first chart shows the percentages for each state, as well as the overall regional percentage from 2002 to 2016. The second chart shows the number of attaining and non-attaining acres of subwatersheds, as well as subwatershed acres with insufficient data, in New Jersey from 2002 to 2016. The final chart shows the number of attaining, non-attaining, and unassessed stream miles in Pennsylvania from 2002 to 2016.</p>`,
            how: `<p>From 2006 to 2014, the percentage of waterbodies attaining water quality standards declined 8.7%. This figure held relatively steady (between 35% and 39% in attainment) between 2006 and 2012 before declining more dramatically to only 26% of waterbodies in attainment in 2014 (the last year data is available for both states).  Pennsylvania saw a more dramatic decrease in waterbodies in attainment—57% in 2012 to 39% in 2014. From 2002 to 2014, the percentage of attaining subwatersheds in New Jersey has held relatively steady between 13% and 18%.</p><p>However, this decline does not necessarily reflect an actual reduction in the quality of surface water. Prior to releasing the 2014 report, PADEP adopted more stringent biological assessment protocols. As a result, a number of previously attaining streams were downgraded, and this is reflected in the significant drop between the 2012 and 2014 reports. As of 2016, almost all streams have been reassessed with the new protocol, and the overall number of attaining stream miles declined only slightly since 2014 (from 1,507.2 miles to 1,440.5 miles).</p>`,
            resource: `<p>Go to DVRPC's <a target="_blank" rel="noopener" href="/WaterQuality/">Water Quality</a> page to learn more about our work to improve this critical resource.</p><p>DVRPC's <a target="_blank" rel="noopener" href="/Connections2045/MIT/"><em>Municipal Implementation Toolbox</em></a> suggests the following tools for improving the region's water quality trendline:</p><ul><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf42985e7179a56e2137792">Comprehensive Environmental Protection Ordinance</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf429a3e7179a56e213779c">Stream Corridor Protection Ordinance</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf429b2e7179a56e21377a6">Stormwater Ordinances</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf429c1e7179a56e21377a9">Stormwater Fees</a></li></ul>`
        }
    },
    'Land Consumption': {
        ...
        text: {
            why: `<p>Greater Philadelphia must balance a variety of land uses to maintain a high quality of life for its residents and visitors with the finite amount of land available. One of the most important land use decisions that our region's decision-makers face is choosing to develop open space for housing, business, or industry; or to protect it for recreation, water quality, habitat, natural beauty, or farmland. Over the past 75 years, land consumption has increased at a rate nearly five times the region's population growth, resulting in sprawling development patterns. There are many negative effects of this inefficient use of the region's land, including:</p><ul><li>increased reliance on motorized transportation, which in turn results in the congestion of our roadways and an increased need for new infrastructure to reduce this congestion;</li><li>increased need for redundant amenities and services as communities become more spread out;</li><li>more time each day spent traveling between destinations, which affects mental and physical health;</li><li>challenges to, if not loss of, local agricultural economies;</li><li>a weakening of the ability of other species to thrive as their habitats are lost or movement between habitats is prevented; and</li><li>detrimental impacts to air and water quality.</li></ul>`,
            what: `<p>DVRPC has tracked regional land use changes and the preservation of land for decades. Since 1970, DVRPC has produced land use files derived from aerial photography in our nine-county region. Starting in 1990, these digital land use files have been produced every five years using Computer Assisted Mapping and Geographic Information Systems software. Methods and technology were updated for the 2000 inventory and subsequent releases. Although reasonable comparisons can be drawn between DVRPC's land use files produced in 2005 or later, users should be cautious when comparing these later files to earlier land use data, particularly within specific developed land use categories and/or specific municipalities.</p><p>Chart 1 shows how many acres have been developed at the regional and subregional levels since 1970, as well as how many acres of land have been used for agricultural purposes. Chart 2 shows how regional and subregional land use types have changed since 1970.</p><p>DVRPC also maintains an inventory of protected public and private open space in the region. The inventory tracks all publicly owned open space, and preserved farmland and nonprofit-protected open space (both of which are typically still owned by private landowners). States, counties, municipalities, and nonprofits (such as land trusts and conservancies) may purchase a parcel of land outright for preservation or purchase the development rights to the parcel.  Purchase of development rights is common for farmland, enabling the farmer landowner to continue working on the land.  Outright purchase of the parcel (not just development rights but full ownership of the parcel) can be accomplished by both public and private entities. Funding sources for land conservation vary, but public entities typically use tax funds, while nonprofits may use a combination of public and private sources, including income and estate tax deductions.</p><p>Updates to the protected open space inventory follow the four-year Long-Range Plan cycle. Data is available for 2004, 2007, 2011, and 2016. As with land use data, calculation methods and the accuracy of protected open space data have changed and improved over time.</p><p>Chart 3 shows acreage permanently protected from future development, including by public and private ownership at the regional and subregional levels. Chart 4 shows the type of protected open space (federal, state, or local government; non-profit; or preserved farmland) by a selected regional or subregional geography.</p>`,
            how: `<p>The rapid rate of land development has been unsustainable over the last 25 years (13% increase in acres per capita) but has slowed over the past decade. From 1990 to 2005, the total number of developed acres in the region increased by 157,000, which is equivalent to 29 acres of development per day over the period. From 2005 to 2015, the rate of development decreased to 11 acres per day—a 62% drop in consumption rate.  The Great Recession played a role in this slowdown, but the extensive land preservation efforts in the region, along with changing preferences toward redevelopment and greater density have also helped improve the trajectory.     </p><p>From 1990 to 2015, the region lost 78,600 acres of woodlands, a decrease of 9%; and 155,600 acres of agricultural lands, a decrease of 25%. Over that same time period and on some of the same land, land devoted to single-family homes increased by 22%, or 82,600 acres. Chester County developed the most quickly over this period with an additional 52,800 acres of development, an increase of 45%; second was Bucks County with 41,700 more acres developed, an increase of 34%; and third was Montgomery County with 35,400 acres developed, an increase of 24%.</p><p>The Connections 2045 Plan maintains a goal of permanently preserving one million total acres in the region. As of 2016, the most recent year of record, Greater Philadelphia was nearly 60% of the way there, with 591,900 acres preserved. Since DVRPC's 2004 protected open space inventory, the total amount of protected land increased by 170,000 acres, or 40%. During this time, preserved farmland doubled, adding 67,400 acres; non-profit protected lands increased by 57,700 acres, or 123%; and state-owned lands by 23,900 acres, or 12%.</p><p>As of 2016, Burlington County had the most protected open space in the region, largely because of its overlap with New Jersey's protected Pinelands region, with 222,800 acres of preserved land. Chester County was second with 126,200 acres preserved; and Bucks County was third with 77,700 acres preserved. The region's rural areas accounted for 64% of all permanently protected open space with 376,000 acres.</p>`,
            resource: `<p>For more information on DVRPC's efforts toward land preservation and other "smart growth" practices that tackle sprawled development, see:</p><ul><li><a target="_blank" rel="noopener" href="/SmartGrowth/">Smart Growth</a></li><li><a target="_blank" rel="noopener" href="/OpenSpace/">Open Space Planning</a></li></ul><p>DVRPC's <a target="_blank" rel="noopener" href="/Connections2045/MIT/"><em>Municipal Implementation Toolbox</em></a> suggests the following tools for improving the region's trendline for land consumption and open space preservation:</p><ul><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf42867e7179a56e21376cc">Official Map</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf428d3e7179a56e2137742">Parkland Dedication and Fee-in-lieu</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf42930e7179a56e2137776">Land Acquisition and Conservation Easements</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf42958e7179a56e2137787">Dedicated Open Space Funding</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf42985e7179a56e2137792">Comprehensive Environmental Protection Ordinance</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf429fde7179a56e21377c7">Agricultural Zoning</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf42a0ce7179a56e21377ca">Right-to-Farm Provisions</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5c929acde7179a0e4089fb5d">Brownfields Redevelopment</a></li><li><a target="_blank" rel="noopener" href="/Connections2045/MIT/toolpage.html?tool=5bf42b29e7179a56e2137849">Smart Location of Public Facilities</a></li></ul>`
        }
    },
    'Pavement Conditions': {
