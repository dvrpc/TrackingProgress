  ...
  "Commute Mode": {
    ...
    d3: [
      ...
      },
      {
        ...
        data: [
          { key: "DVRPC", columns: ["year", "dvrpcpool"] },
          { key: "NJ Counties", columns: ["year", "njcospool"], disabled: true },
          { key: "PA Suburban Counties", columns: ["year", "pasubpool"], disabled: true },
          { key: "Bucks", columns: ["year", "buckpool"], disabled: true },
          { key: "Burlington", columns: ["year", "burlpool"], disabled: true },
          { key: "Camden", columns: ["year", "camdpool"], disabled: true },
          { key: "Chester", columns: ["year", "chespool"], disabled: true },
          { key: "Delaware", columns: ["year", "delapool"], disabled: true },
          { key: "Gloucester", columns: ["year", "glocpool"], disabled: true },
          { key: "Mercer", columns: ["year", "mercpool"], disabled: true },
          { key: "Montgomery", columns: ["year", "montpool"], disabled: true },
          { key: "Philadelphia", columns: ["year", "philpool"], disabled: true },
       ],
      },
    ],
  },
    ...
    d3: [
      {
        ...
        columnOptions: [
          ...
          [
            ...
            "Bucks- NHS, interstate",
            "Burlington- NHS, interstate",
            "Camden- NHS, interstate",
            "Chester- NHS, interstate",
            "Delaware- NHS, interstate",
            "Gloucester- NHS, interstate",
            "Mercer- NHS, interstate",
            "Montgomery- NHS, interstate",
            "Philadelphia- NHS, interstate",
          ],
          [
            "DVRPC- NHS, non-interstate",
            "New Jersey- NHS, non-interstate",
            "Pennsylvania- NHS, non-interstate",
            "Bucks- NHS, non-interstate",
            "Burlington- NHS, non-interstate",
            "Camden- NHS, non-interstate",
            "Chester- NHS, non-interstate",
            "Delaware- NHS, non-interstate",
            "Gloucester- NHS, non-interstate",
            "Mercer- NHS, non-interstate",
            "Montgomery- NHS, non-interstate",
            "Philadelphia- NHS, non-interstate",
          ],
          [
            "DVRPC- Non-NHS",
            "New Jersey- Non-NHS",
