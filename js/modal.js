  ...
  dash: [
    {
      id: "hover-tiles",
      caption:
        "Mouse-over the tiles for a quick glimpse of how we're doing based on the latest data.",
    },
    {
      id: "toggle-filters",
      caption:
        "Click filters to sort indicators by category or historic trend.",
    },
    {
      id: "click-indicator",
  ...
  indicators: [
    {
      id: "indicator-text",
      caption:
        "Read each indicator's four narrative tabs to learn more, read analysis and explore othe resources.",
    },
    {
      id: "indicator-data",
      caption:
        "Interact with charts by hovering over data points. Toggle data with the legend &amp; dropdown menus.",
    },
    {
      id: "indicator-nav",
      caption:
        "View related indicators or return to the dashboard to view all indicators.",
    },
  ],
};
